"""Rust environment/shell endpoint claim binding; generated intermediate code is never an anchor."""

from traceproof.rust_env_parser import parse_isolated
...
def anchors(bundle, snippet, claim):
    ...
    if (
        ...
        return []
    context = complete_context(bundle, snippet, ".rs")
    if context is None:
        return []
    parsed = parse_isolated(context.encode())
