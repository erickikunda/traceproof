...
from traceproof.artifacts import open_scoped_source
from traceproof.domain import Contract, Digest, FileRecord, Identifier, TraceProofError
from traceproof.git_acquisition import validate_remote
