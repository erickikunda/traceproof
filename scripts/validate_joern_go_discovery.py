"""Opt-in durable experimental Go discovery fixture pair; no LLM calls."""
...
fixtures = Path(__file__).resolve().parents[1] / "tests/fixtures/joern-go"
...
try:
    for name, count in {
        ...
        attempt = discover(store, run, args.joern_home, language="go")
