"""Opt-in durable experimental C/C++ discovery fixture pair; no LLM calls."""
...
fixtures = Path(__file__).resolve().parents[1] / "tests/fixtures/joern-c-family" / args.language
