"""Validate bounded Express request-to-eval discovery through the main pipeline."""
...
extension = "js" if args.language == "javascript" else "ts"
...
try:
    for name, count in {
        ...
        with zipfile.ZipFile(archive, "w") as out:
            for file in (fixtures / name).rglob(f"*.{extension}"):
