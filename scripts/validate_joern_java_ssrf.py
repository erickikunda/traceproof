"""Restricted native CWE-918 fixture acceptance; no model calls."""
...
root = Path("/work/java-ssrf-validation")
root.mkdir()
fixtures = Path("/repo/tests/fixtures/joern-java-ssrf")
results = []
...
try:
    ...
    for case, count in {
        ...
        result = scan_run(
            ...
            joern_profile="java-spring-url-stream-v1",
        )
