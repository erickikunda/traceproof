"""Restricted native CWE-502 fixture acceptance; no model calls."""
...
root = Path("/work/java-deserialization-validation")
root.mkdir()
fixtures = Path("/repo/tests/fixtures/joern-java-deserialization")
results = []
...
try:
    ...
    for case, count in {
        ...
        result = scan_run(
            ...
            joern_profile="java-spring-object-read-v1",
        )
