"""Opt-in durable experimental JavaScript/TypeScript discovery fixture pair; no LLM calls."""
...
fixtures = Path(__file__).resolve().parents[1] / "tests/fixtures/joern-javascript" / args.language
...
try:
    for name, count in {
        ...
        attempt = discover(store, run, args.joern_home, language=args.language)
