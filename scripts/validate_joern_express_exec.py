"""Restricted native CWE-78 fixture acceptance; no model calls."""
...
root = Path("/work/exec-validation")
root.mkdir()
fixtures = Path("/repo/tests/fixtures/joern-express-exec") / language
results = []
...
try:
    ...
    for case, count in {
        ...
        result = scan_run(
            ...
            joern_profile="express-request-exec-v1",
        )
