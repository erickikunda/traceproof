"""Opt-in durable experimental Python discovery fixture pair; no LLM calls."""
...
fixtures = Path(__file__).resolve().parents[1] / "tests/fixtures/joern-python"
...
try:
    for name, count in {
        ...
        options = dict(engine="joern", language="auto", joern_home=args.joern_home)
