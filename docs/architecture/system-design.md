...
**Implementation checkpoint:** through Slice 124. This document separates the implemented laptop POC from the proposed enterprise architecture. It is not an approved Wells Fargo architecture.
