...
Java selects the existing Spring/JDBC SQL, Spring file-path and URL.openStream SSRF profiles.
JavaScript/TypeScript select Express eval and child_process.exec, Go HTTP shell, Rust environment shell,
